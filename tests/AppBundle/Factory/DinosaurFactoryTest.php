...
class DinosaurFactoryTest extends TestCase
{
    ...
    /**
     * @var DinosaurLengthDeterninator|\PHPUnit\Framework\MockObject\MockObject
     */
    private $lengthDeterminator;

    public function setUp()
    {
        $this->lengthDeterminator = $this->createMock(DinosaurLengthDeterninator::class);
    ...
    public function testItGrowsATricerotops()
    {
